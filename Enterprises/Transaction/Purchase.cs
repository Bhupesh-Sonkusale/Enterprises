...
namespace Enterprises.Transaction
{
    ...
    {
        DataTable dt;
        string Message = ""; decimal TOTAL_GST = 0; public string WITH_BATCH;
        int _result = 0; public bool FINANCIAL_STATUS;
        DAL dal = new DAL(); public string USER_ID; public string GST_IN;
        ...
        public void PARTICULAR_LIST(string PARTICULAR_)
        {
            try
            {
                ...
                grdDataParticular.Columns["MRP"].HeaderText = "Rate";
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string ID = dal.ExecuteScaler("SP_PURCHASE", ref Message).ToString();

                    string PURCHASE_ID = "PUR_" + ID;
                    ...
                    dal.AddParameter("@NAME", PARTY_NAME.Text.Trim(), "IN");
                    dal.AddParameter("@MOBILE", MOBILE.Text.Trim(), "IN");
                    ...
                    dal.AddParameter("@GST", TOTAL_GST.ToString(), "IN");
        ...
        private void BILL_ID_Enter(object sender, EventArgs e)
        {
            BILL_ID.BackColor = Color.MistyRose;
        }

        private void BILL_ID_Leave(object sender, EventArgs e)
        {
            BILL_ID.BackColor = Color.White;
        }

        private void BILL_DATE_Enter(object sender, EventArgs e)
        {
            BILL_DATE.BackColor = Color.MistyRose;
        }

        private void BILL_DATE_Leave(object sender, EventArgs e)
        {
            BILL_DATE.BackColor = Color.White;
        }
