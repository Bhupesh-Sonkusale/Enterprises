    ...
    public partial class CompanyOrder : Form
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dal.AddParameter("@SUB_TYPE", "ORDER_LIST", "IN");
        ...
        {
            dt = dal.GetTable("SP_COMPANY_ORDER", ref Message);
            if (dt.Rows.Count > 0)
            {
        ...
        private void grdData_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                {
                    string ORDER_ID = grdData.CurrentRow.Cells[4].Value.ToString().Trim();
